function [data, info] = objeto
%Objeto gives an empty data for hexapod_interfaces/Objeto
% Copyright 2019-2021 The MathWorks, Inc.
data = struct();
data.MessageType = 'hexapod_interfaces/Objeto';
...
info.MessageType = 'hexapod_interfaces/Objeto';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
